      ...
      <div class="pcoded-container navbar-wrapper">
          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                ...
                <h3>Income Details</h3><br>
                  <div class="row">
                    ...
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        <label>Source</label>
                        <input type="text" name="source" class="form-control" placeholder="Enter Income Source"  value="" required>
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>Amount</label>
                        <input type="text" name="amount" class="form-control" placeholder="Enter Income Amount" required>
                      </div>
                    </div>
                ...
                <a href="income report.php" class="btn btn-fill btn-primary">View Details</a>
              </div>
            </div>
                </form>
                                                            </div>
