      ...
      <div class="pcoded-container navbar-wrapper">
          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="description" class="form-control" placeholder="Enter Expense Type"  value="" required>
                      </div>
                    </div>
                ...
                <a href="expense report.php" class="btn btn-fill btn-primary">View Details</a>
              </div>
            </div>
                </form>
                                                            </div>
