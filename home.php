                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <?php 
                                                                ...
                                                                <a href="income.php"><h6 class="text-muted m-b-0" style="text-decoration:underline">Add Income</h6></a>
                                                             </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <a href="expense.php"><h6 class="text-muted m-b-0" style="text-decoration:underline">Add Expense</h6></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-6 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green"><?php echo $monthlyexpense; ?></h4>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Income in this year</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-purple">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Expense in this year</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-green">
