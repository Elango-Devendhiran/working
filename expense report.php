...
if(!isset($_SESSION["id"])){
 ...
 $result = $con->query("select * from register where id=".$_SESSION["id"]);
...
// 	$amount= $_POST['amount'];	
// 	$sql = "insert into expense (date,description,amount) values ('".$date."','".$description."','".$amount."')";
...
<?php
$sql = "select * from expense ORDER by date";
$expense_result = $con->query($sql);
?>
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="icon.jpg" class="img-radius" alt="User-Profile-Image">
                                  <?php
                                    $id=$_SESSION['id'];
              ...
              <div class="pcoded-wrapper">
                  <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <div class="pcoded-navigation-label" data-i18n="nav.category.navigation">Income & Expense Master</div>
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="home.php" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Home</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="income.php" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Income</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="#" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Expense</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="expense.php">Expense</a>
                                          </li>
                                          <li class="breadcrumb-item"><a href="expense report.php">Expense Report</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                   ...
                   <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                      ...
                      <label>From Date :</label>
                        <input type="date" id="datepicker" name="from_date" class="form-control" required>
                    </div>
                     <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                      
                      <label>To Date :</label>
                        <input type="date" id="datepicker" name="to_date" class="form-control"  required>
                      </div>
                      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">

                        <button type="submit" name="submit" class="btn btn-fill btn-primary" style="margin-top: 20px;">Filter</button>
                    </div>
                    ...
                    <tbody>
                        ...
                        if(isset($_POST['from_date'])&&isset($_POST['to_date']))
                                                ...
                                                if (mysqli_num_rows($result)>0) {
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                        echo'<td>
                                                        <button class="btn btn-primary"><a href="update income.php?updateid='.$id.'" style="text-decoration:none" class="text-light">Update</a></button>
                                                        <button class="btn btn-danger"><a href="delete income.php?deleteid='.$id.'" style="text-decoration:none" class="text-light">Delete</a></button>
                                                                                </td>';
                                                        ?>
                                                    </tr>
                                                    <?php
                                                ...
                                                {
                                                echo "<p class='color'>No Records Found</p>";
                                                }
                        ...
                        echo'<td>
                        <button class="btn btn-primary"><a href="update expense.php?updateid='.$id.'" style="text-decoration:none" class="text-light">Update</a></button>
                        <button class="btn btn-danger"><a href="delete expense.php?deleteid='.$id.'" style="text-decoration:none" class="text-light">Delete</a></button>
                                                </td>';
                        ...
                        ?> 
                        <tr><td colspan="3" style="text-align:right" class="text-primary"><b>Total</b></td>
                    
                    <td>                             
                        <?php 
                        if(isset($_POST['from_date']) && isset($_POST['to_date']))
                        {
                            $result = mysqli_query($con, "SELECT SUM(amount) AS amount_sum FROM expense where date BETWEEN '$from_date' AND '$to_date'"); 
                            ...
                            $result = mysqli_query($con, "SELECT SUM(amount) AS amount_sum FROM expense"); 
                            $row = mysqli_fetch_assoc($result); 
                            $sum = $row['amount_sum'];
                            echo $sum;
                        }
