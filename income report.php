...
// 	$source= $_POST['source'];
// 	$amount= $_POST['amount'];	
// 	$sql = "insert into income (date,source,amount) values ('".$date."','".$source."','".$amount."')";
...
<?php
$sql = "select * from income ORDER by date";
$income_result = $con->query($sql);
?>
                   ...
                   <div class="row">
                    ...
                    <tbody>
                        ...
                        if(isset($_POST['from_date'])&&isset($_POST['to_date']))
                                                ...
                                                $sql="select * from income where date BETWEEN '$from_date' AND '$to_date' ";
                                                $counter=0;
                        ...
                        if(isset($_POST['from_date']) && isset($_POST['to_date']))
                        {
                            $result = mysqli_query($con, "SELECT SUM(amount) AS amount_sum FROM income where date BETWEEN '$from_date' AND '$to_date'"); 
                            ...
                            $result = mysqli_query($con, "SELECT SUM(amount) AS amount_sum FROM income"); 
                            $row = mysqli_fetch_assoc($result); 
                            $sum = $row['amount_sum'];
                            echo $sum;
                        }
