...
if (strlen($_SESSION['id']=='.$id.')) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    //     if(move_uploaded_file($_FILES['file']['tmp_name'],'profileimage/'.$name)){
     ...
     $query=mysqli_query($con, "update register set photo='$photo', name ='$name', dob='$dob', age='$age', email = '$email', mobile='$mobile',address='$address', password='$password' where id='$id'");
                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                           ...
                           <p style="font-size:16px; color:red" align="center"> 
                            ...
                            <form role="form" method="post" action="" runat="server">
                            ...
                            <input type="file" name="upload" accept="image/png, image/gif, image/jpeg"  id="imgInp" onchange="loadFile(event)" />

                            <img id="blah" src="" style="width:50px ;height:50px; border-radius: 50%;" alt="Profile Photo">
								...
								<div class="form-group">
									...
									<input class="form-control" id="name" type="text" value="<?php  echo $row['name'];?>" name="name" required="true">
								</div>


                                <div class="form-group">
									<label>Date of Birth</label>
									<input class="form-control"  id="dateofbirth" type="text"   name="dob" required>
								</div>
                            ...
                            <input type="email" class="form-control" name="email" value="<?php  echo $row['email'];?>" required="true">
								...
								<div class="form-group">
                                    ...
                                    ?>
									<input class="form-control" type="text" value="<?php  echo $row['mobile'];?>" required="true" name="mobile" maxlength="10">
								</div>
                                ...
                                <div class="form-group">
									<label>Address</label>
									<textarea type="text" class="form-control" required="true" name="address" maxlength="196"></textarea>
								</div>
                                ...
                                <div class="form-group">
									...
									<input class="form-control" type="password" value="<?php  echo $row['password'];?>" required="true" name="password">
								</div>
